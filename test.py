...
if __name__ == "__main__":
    ...
    'required': ['name', 'dob', 'problem_description', 'accident_type', 'accident_reported', 'family_history'],
    'title': 'User',
    'type': 'object',
    "additionalProperties": False,
    }
